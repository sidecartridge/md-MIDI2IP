...
captured by the existing PIO/DMA ring and routed straight to the network, with no
TPROTOCOL frame and no token spin.
...
throughput is well above the 31250-baud wire rate. **Met:** sustained hundreds of
