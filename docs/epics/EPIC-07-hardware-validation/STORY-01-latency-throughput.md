...
- [x] Define the target as per-hop latency ≤ physical MIDI ring-speed-per-hop (~hundreds of µs at 31250 baud + per-machine processing); interception before the ACIA means this should be achievable or better on a LAN (C-01)
