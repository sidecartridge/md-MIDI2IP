...
- [x] Automated build gate: `.github/workflows/build.yml` builds `pico_w` Release on every PR, catching compile/link/budget regressions across both targets (green on the EPIC-09 PR #7)
